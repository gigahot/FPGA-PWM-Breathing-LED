...
2. Open the .qpf project file for the desired phase in Quartus II.

3. Verify the pin assignments in the Pin Planner (LED0~LED9, CLK, RST).

4. Compile the project and program the .sof file to your Cyclone III board.
