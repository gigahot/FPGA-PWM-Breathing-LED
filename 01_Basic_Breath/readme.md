...
1111111111 -> 100% Bright
ness1111111110 -> 90% Brightness
0000000000 -> 0% (OFF)
...
At duty_zero: tango is set to 1 (Triggering an upward transition).
At duty_ten: tango is set to 0 (Triggering a downward transition).
...
### 3. Precision Timing (up_cnt_pmtr.v)
I divided this into 20 state changes (covering 11 distinct brightness levels from 100% down to 0% and back).
